...
alias clean='sudo apt clean && sudo apt autoclean && sudo apt autoremove -y'
alias ps='ps -aux'
alias df='df -h -x none -x tools -x drivers -x lib -x tmpfs'
alias free='free -h'
...
alias dimgrm='docker system prune -a'   # Remove all the images not in use by any container
